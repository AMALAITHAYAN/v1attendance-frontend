...
// --- Icon Imports ---
import { FaKey, FaEye, FaEyeSlash, FaSave, FaUserShield } from 'react-icons/fa';
  ...
  return (
    <div style={styles.bar}>
      <div style={styles.userInfo}>
        <FaUserShield size={20} color={styles.theme['--text-secondary']} />
        <div>
            <div style={styles.userLabel}>Teacher</div>
